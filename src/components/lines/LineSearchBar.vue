...
<template>
  <AppCard class="line-search-card">
    <div class="line-search-card__body">
      <AppSearchField
        class="line-search-card__field"
      ...
      <p class="line-search-card__hint">
...
<style scoped>
.line-search-card__body {
  padding: 10px 20px;
}

.line-search-card__field {
  flex: 1;
  min-width: 0;
}

.line-search-card__field:deep(input) {
  height: 38px;
  font-size: 13px;
}

.line-search-card__field:deep(.h-\[44px\]) {
  height: 38px;
}

.line-search-card__field:deep(button) {
  height: 38px;
  padding-inline: 14px;
  font-size: 12px;
}

.line-search-card__hint {
  margin: 8px 2px 0;
  color: #64748b;
  font-size: 12px;
  font-weight: 600;
