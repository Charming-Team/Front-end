...
//         requiresAuth: true,
//         pageTitle: '주문 관리',
//         pageDescription: '주문 상세 화면을 확인합니다.',
//         activeMenu: 'orders',
//       },
//     },
//     {
...
//         requiresAuth: true,
//         pageTitle: '생산계획 관리',
//         pageDescription: '생산계획 상세 정보를 확인합니다.',
//         activeMenu: 'production',
//       },
//     },
//     {
...
//         requiresAuth: true,
//         pageTitle: '자재 현황',
//         pageDescription: '자재 상세 상태를 확인합니다.',
//         activeMenu: 'materials',
//       },
//     },
//     {
...
//         requiresAuth: true,
//         pageTitle: '라인 현황',
//         pageDescription: '라인 상세 현황을 확인합니다.',
//         activeMenu: 'lines',
//       },
//     },
//     {
...
//         requiresAuth: true,
//         pageTitle: '라인 현황',
//         pageDescription: '라인별 가동 현황을 확인합니다.',
//         activeMenu: 'lines',
//       },
//     },
//     {
...
//         requiresAuth: true,
//         pageTitle: '라인 현황',
//         pageDescription: '생산 라인 상세 현황을 확인합니다.',
//         activeMenu: 'lines',
//       },
//     },
//     {
...
//     /**
//      * CSS 수정용 AI 우회 라우트
//      * /ai 경로는 Vite proxy에 잡힐 수 있으므로 /style/ai 경로로 접근한다.
//      */
//     {
//       path: '/style/ai/analysis',
//       component: () => import('./pages/ai/AiAnalysisPage.vue'),
//       meta: {
//         requiresAuth: true,
//         pageTitle: 'AI 분석',
...
//     },
//     {
//       path: '/style/ai/result',
//       component: () => import('./pages/ai/AiResultPage.vue'),
//       meta: {
//         requiresAuth: true,
//         pageTitle: '생산 계획 생성 완료',
//         pageDescription: 'AI 분석 결과를 확인합니다.',
//         activeMenu: 'production',
//       },
//     },
//     {
//       path: '/style/ai/detail',
//       component: () => import('./pages/ai/AiDetailPage.vue'),
//       meta: {
//         requiresAuth: true,
//         pageTitle: '대응안 상세 비교',
...
// function getStyleDevQuery(to) {
//   if (to.path.includes('/ai/analysis')) {
//     return {
//       chatRequestId: to.params.id || '1',
//       planId: '1',
//       lineId: '1',
//       orderId: '1',
//     };
...
//   if (to.path.includes('/ai/result')) {
//     return {
//       simulationGroupId: 'SIM-GRP-TEST-001',
//       simulationId: to.params.id || '1',
//       planId: '1',
//     };
//   }

//   if (to.path.includes('/ai/detail')) {
//     return {
//       simulationId: to.params.id || '1',
//       simulationGroupId: 'SIM-GRP-TEST-001',
//       planId: '1',
...
//     return {
//       orderId: to.params.id || '1',
//     };
//   }

//   if (to.path.startsWith('/materials')) {
//     return {
//       materialId: to.params.id || '1',
//     };
//   }

//   if (to.path.startsWith('/lines') || to.path.startsWith('/production-lines')) {
//     return {
//       lineId: to.params.id || '1',
//     };
//   }

//   if (to.path.startsWith('/production-plans') || to.path === '/plan') {
//     return {
//       planId: to.params.id || '1',
//     };
//   }
...
// router.beforeEach((to) => {
//   if (IS_STYLE_DEV) {
//     const defaultQuery = getStyleDevQuery(to);

//     if (defaultQuery) {
//       const hasMissingQuery = Object.keys(defaultQuery).some(
//         key => to.query[key] === undefined || to.query[key] === ''
//       );
